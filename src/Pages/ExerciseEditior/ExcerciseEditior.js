      ...
      <div className="row">
        ...
        <div className="col-sm-12 col-md-4 d-flex justify-content-center align-items-center mt-2">
          ...
          >
            ...
            elastic band around your knees and pull your knees apart. Hold this
            and then tighten your lower abdominal muscles, squeeze your buttocks
            and raise your buttocks off the floor/bed as creating a "Bridge"
            with your body.
          </textarea>
        </div>
        <div className="col-sm-12 col-md-4  leftmarf">
          <div className="m-2">
        ...
        <div>
          <div className="m-3">
            <b style={{ marginLeft: "12px" }}>7.4M</b> Sent
          </div>
          <br />
          <div className="">
            <sapn style={{ marginLeft: "18px" }}>Created - Jan 10th, 2011</sapn>
          </div>
        </div>
      </div>
      <hr />
      <div className="text-center m-2">Copyright © 2023 HEP2go Inc.</div>
    </Container>
  );
};
