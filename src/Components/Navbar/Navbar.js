  ...
  return (
    <center>
        <table width={1024} border={0} cellPadding={0} cellSpacing={0}>
          <tbody><tr>
              <td width={120} height={47}><Link to="/index-home"><img src="https://www.hep2go.com/images/medium-logos/logo-bk.jpg" width={120} height={47} border={0} /></Link></td>
              <td width={120}><a href="http://www.hep2go.com/exercises.php?userRef=gciaake" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','https://www.hep2go.com/buttons/standard_over_bbb.jpg',1)"><img src="https://www.hep2go.com/buttons/standard_bbb.jpg" name="Image4" width={120} height={47} border={0} id="Image4" /></a></td>
              <td width={120}><Link to="/my-stuff/profile" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','https://www.hep2go.com/buttons/exs_ball_over_bbb.jpg',1)"><img src="https://www.hep2go.com/buttons/exs_ball_bbb.jpg"  name="Image5" width={120} height={47} border={0} id="Image5" /></Link></td>
              <td width={120}><img src="https://www.hep2go.com/buttons/quick_bbb.jpg" width={120} height={47} /></td>
              <td width={67} align="left" bgcolor="#000000"><img src="https://www.hep2go.com/buttons/search_bbb.jpg" width={60} height={47} /></td>
              ...
              <td width={272} align="left" valign="middle" background="https://www.hep2go.com/buttons/search_end_bbb.jpg" bgcolor="#000000" style={{paddingRight: '5px'}}><a href="javascript: goSearch();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('searchImg','','https://www.hep2go.com/buttons/mag_glass_bbb.jpg',1)"><img src="https://www.hep2go.com/buttons/mag_glass_bbb.jpg"style={{marginLeft:" 111px"}} alt="Search Site" id="searchImg" name="searchImg" width={26} height={46} border={0} /></a> </td>
            </tr>
          </tbody></table>
